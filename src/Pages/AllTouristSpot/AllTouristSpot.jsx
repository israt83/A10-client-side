  ...
  const fetchData = async () => {
    ...
    try {
      const [touristSpotRes, userSpotRes, touristCountrySpotRes] = await Promise.all([
        fetch(`https://tourism-spot-server.vercel.app/spot?sort=${sortOrder}`),
        fetch(`https://tourism-spot-server.vercel.app/userspot`),
        fetch(`https://tourism-spot-server.vercel.app/countryspot?sort=${sortOrder}`),
      ]);
