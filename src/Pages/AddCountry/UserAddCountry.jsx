...
const UserAddCountry = () => {
    useEffect(() => {
        document.title = 'TOURISTCENTER/UserAddCountry'; 
    }, []); 
	...
	const handleAddSpot = event =>{
        ...
        const newCountry = {userName , email,spotName, countryName , location , description, image ,averagecost,traveltime ,totalvisitors,seasonality}
       console.log(newCountry);


    //    send data to the server
    fetch('https://tourism-spot-server.vercel.app/country',{
        method:'POST',
        headers:{
